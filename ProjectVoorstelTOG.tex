...
\begin{itemize}
    ...
    \item Emir Murat: Multiplication with MTM, Powers with MTM, Logs in HTML and implementation of MTM
		\item Jonathan van der Sluijs: Modulo-operation with MTM, Expression validation with LR parser and Implementation of MTM
    \item Mathis De Herdt: Input GUI in QT, Addition and substraction with MTM, Logs in HTML and Implemenation of MTM
\end{itemize}
...
\hline
Implementation of MTM & Stucture for the MTM & 30 \\
\hline
CFG to CNF to CYK & Algorithm compatibility of members & 10 \\
\hline
Expression Validation with CYK & Syntax checking for input expressions &  20 \\
\hline
LR parser for input validations & Syntax checking for input expressions & 20 \\
\hline
...
\begin{itemize}
    ...
    \item \textbf{Phase 2:} Simulate arithmetic tasks on the Turing Machine and validate input expressions using the CYK algorithm. This phase focuses on implementing core functionality to perform and verify calculations according to CFG rules.
